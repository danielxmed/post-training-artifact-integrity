...
No build system, test runner, or linter exists yet. When tooling is introduced, document the exact commands here (install, run tests, run a single test, lint) and mirror them in `AGENTS.md`.
